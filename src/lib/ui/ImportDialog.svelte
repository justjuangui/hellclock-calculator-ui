<script lang="ts">
  ...
  const hasErrors = $derived(
    (preview?.errors.length ?? 0) > 0 || (importResult?.errors.length ?? 0) > 0,
  );
      ...
      <div class="form-control flex flex-col gap-2">
        ...
        <label class="label cursor-pointer justify-start gap-3">
          ...
          <span class="label-text">
            ...
            <span class="badge badge-sm ml-2"
              >{preview.skills.length} equipped</span
            >
          </span>
        </label>
        ...
        <label class="label cursor-pointer justify-start gap-3">
          ...
          <span class="label-text">
            ...
            <span class="badge badge-sm ml-2"
              >{preview.constellations.length} nodes</span
            >
          </span>
        </label>
      ...
      <div class="text-sm space-y-1">
        {#if importGear && selectedGearLoadout}
          <p>
            ...
            {selectedGearLoadout.gearCount} items from Loadout {selectedGearLoadout.index +
              1}
          </p>
        {/if}
        {#if importSkills}
        ...
        {#if importRelics && selectedLoadout}
          <p>
            ...
            {selectedLoadout.relicCount} items from Loadout {selectedLoadout.index +
              1}
          </p>
        {/if}
